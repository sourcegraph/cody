...
describe('atMentionsSerializer', () => {
    ...
    describe('various deserialization edge cases', () => {
        ...
        it('handles multiple consecutive mentions', () => {
            const s = 'Look at cody://serialized.v1?data=JTdCJTIydHlwZSUyMiUzQSUyMmxpbmVicmVhayUyMiUyQyUyMnZlcnNpb24lMjIlM0ExJTdE_ cody://serialized.v1?data=JTdCJTIydHlwZSUyMiUzQSUyMmxpbmVicmVhayUyMiUyQyUyMnZlcnNpb24lMjIlM0ExJTdE_ cody://serialized.v1?data=JTdCJTIydHlwZSUyMiUzQSUyMmxpbmVicmVhayUyMiUyQyUyMnZlcnNpb24lMjIlM0ExJTdE_'
            const des = deserialize(s)
            expect(JSON.stringify(des)).not.contains('cody://serialized.v1')
        })

        it('handles mentions with special characters in the encoded data', () => {
            const s = 'Check cody://serialized.v1?data=JTdCJTIydHlwZSUyMiUzQSUyMmxpbmVicmVhayUyMiUyQyUyMnZlcnNpb24lMjIlM0ExJTdE_'
            const des = deserialize(s)
            expect(JSON.stringify(des)).not.contains('cody://serialized.v1')
        })

        it('handles mentions at start and end of string', () => {
            const s = 'cody://serialized.v1?data=JTdCJTIydHlwZSUyMiUzQSUyMmxpbmVicmVhayUyMiUyQyUyMnZlcnNpb24lMjIlM0ExJTdE_ middle text cody://serialized.v1?data=JTdCJTIydHlwZSUyMiUzQSUyMmxpbmVicmVhayUyMiUyQyUyMnZlcnNpb24lMjIlM0ExJTdE_'
            const des = deserialize(s)
            expect(JSON.stringify(des)).not.contains('cody://serialized.v1')
        })

        it('handles mentions with surrounding punctuation', () => {
            const s = 'Look (cody://serialized.v1?data=JTdCJTIydHlwZSUyMiUzQSUyMmxpbmVicmVhayUyMiUyQyUyMnZlcnNpb24lMjIlM0ExJTdE_), then [cody://serialized.v1?data=JTdCJTIydHlwZSUyMiUzQSUyMmxpbmVicmVhayUyMiUyQyUyMnZlcnNpb24lMjIlM0ExJTdE_]!'
            const des = deserialize(s)
            expect(JSON.stringify(des)).not.contains('cody://serialized.v1')
        })

        it('handles mentions with line breaks and whitespace', () => {
            const s = 'First cody://serialized.v1?data=JTdCJTIydHlwZSUyMiUzQSUyMmxpbmVicmVhayUyMiUyQyUyMnZlcnNpb24lMjIlM0ExJTdE_\nThen cody://serialized.v1?data=JTdCJTIydHlwZSUyMiUzQSUyMmxpbmVicmVhayUyMiUyQyUyMnZlcnNpb24lMjIlM0ExJTdE_\r\n  cody://serialized.v1?data=JTdCJTIydHlwZSUyMiUzQSUyMmxpbmVicmVhayUyMiUyQyUyMnZlcnNpb24lMjIlM0ExJTdE_'
            const des = deserialize(s)
            expect(JSON.stringify(des)).not.contains('cody://serialized.v1')
        })

        it('handles escaped serialized mentions', () => {
            const s = 'Link to \\cody://serialized.v1?data=JTdCJTIydHlwZSUyMiUzQSUyMmxpbmVicmVhayUyMiUyQyUyMnZlcnNpb24lMjIlM0ExJTdE_ but reference cody://serialized.v1?data=JTdCJTIydHlwZSUyMiUzQSUyMmxpbmVicmVhayUyMiUyQyUyMnZlcnNpb24lMjIlM0ExJTdE_'
            const des = deserialize(s)
            expect(JSON.stringify(des)).not.contains('cody://serialized.v1')
        })
    })
