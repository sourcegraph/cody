...
class ExplainFirstInteraction extends Interaction {
    public override getNextInteraction(): Interaction | undefined {
        return new Interaction(
            {
                speaker: 'human',
                text: 'Write a summary explaining the code to our colleague. Start with the purpose of this code. Then give the most interesting supporting details grounded in the facts from your earlier research.',
...
export class ExplainCodeHighLevel implements Recipe {
    ...
    public async getInteraction(_humanChatInput: string, context: RecipeContext): Promise<Interaction | null> {
        ...
        const promptMessage = `We need to read and understand this code to explain to our colleague
