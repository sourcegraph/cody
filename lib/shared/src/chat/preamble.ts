...
For executionable terminal commands, enclose the command with markdown code block with the language tag "shell".
File path that is not part of a code block should be enclosed with single backticks.`
