import type { ClientCapabilities as AgentClientCapabilities } from '../../../../vscode/src/jsonrpc/agent-protocol'
...
/**
 * Set the {@link ClientCapabilitiesWithLegacyFields} value from the {@link ResolvedConfiguration.configuration} and
 * the agent's {@link ClientCapabilitiesWithLegacyFields}.
 */
export function setClientCapabilities(
    configuration: NonNullable<typeof _configuration>,
    agentCapabilities: AgentClientCapabilities
): void {
