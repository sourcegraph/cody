...
This code lib/shared/test/ is usable.
...
This code <span class="token-file token-not-hallucinated" title="No hallucination detected: file exists">lib/shared/test/</span> is usable.
...
const validFilePaths = new Set(['file/path.js', 'this/is/a/directory', 'so/is/this', 'lib/shared/test/'])
...
describe('Hallucinations detector', () => {
    ...
    it('findFilePaths', () => {
        const cases: {
            ...
            {
                input: 'lib/shared/test/',
                output: [{ fullMatch: 'lib/shared/test/', pathMatch: 'lib/shared/test/' }],
            },
        ]
