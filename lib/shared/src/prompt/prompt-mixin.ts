 ...
 */
const CONTEXT_PREAMBLE = ps`You have access to my codebase context but ignore them as needed. To be helpful, always provide a positive answer with high-level overview and guidance without apologizing. Question: `
