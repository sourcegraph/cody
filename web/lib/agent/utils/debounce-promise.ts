...
export function debouncePromise<T extends (...args: any) => Promise<any>, B>(func: T, debounceDelay?: number): (...args: Parameters<T>) => Promise<Awaited<ReturnType<T>> | 'skipped'> {
    ...
    return (...args: any) => new Promise<Awaited<ReturnType<T>> | 'skipped'>((resolve) => {
