export const GENERAL_HELP_LABEL =
...
export const NO_SYMBOL_MATCHES_HELP_LABEL =
...
export const FILE_RANGE_TOOLTIP_LABEL =
	"Type a line range to include, e.g. 5-10...";
export const LARGE_FILE_WARNING_LABEL =
	"File too large. Add line range with : or use @# to choose a symbol";
export const IGNORED_FILE_WARNING_LABEL =
	"Ignored due to cody.contextFilters Enterprise configuration setting";
