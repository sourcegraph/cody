...
export const FILE_RANGE_TOOLTIP_LABEL = 'Add context from range...'
export const LARGE_FILE_WARNING_LABEL = 'File too large. Add lines with : or @# to choose a symbol'
export const LARGE_FILE_WITH_RANGE_WARNING_LABEL = 'File will be excluded if context range exceeds limit'
