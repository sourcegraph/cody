    ...
    describe('tryAddContext', () => {
        ...
        it('preserves context items content', async () => {
            ...
            expect(promptContent).toMatchInlineSnapshot(`
              ...
              Ok.
              Hi!
              The provided context are the code you need and have access to. Do not make any assumptions. Give me a high-level overview based on the given context first before asking for additional context to answer the following question: Hi!"
            `)
        })
    })
})
