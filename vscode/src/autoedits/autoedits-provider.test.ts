...
describe('AutoeditsProvider', () => {
    ...
    describe('scope overflow detection', () => {
        it('should discard suggestions with scope overflow (LLM returns content beyond intended replacement range)', async () => {
            // This test reproduces the exact bug from debug data where:
            // - codeToRewrite only includes the beginning of a class
            // - LLM prediction includes the entire class with methods that already exist in the file
