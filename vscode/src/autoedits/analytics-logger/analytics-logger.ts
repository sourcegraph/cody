...
import { autoeditDebugStore } from '../debugging/debug-store'
...
export class AutoeditAnalyticsLogger {
    ...
    public createRequest({
        ...
        autoeditDebugStore.addAutoeditRequestDebugState(request)
    ...
    public markAsLoaded({
        ...
        payload: Required<
            Pick<LoadedState['payload'], 'source' | 'isFuzzyMatch' | 'responseHeaders' | 'prediction'>
        >
    }): void {
