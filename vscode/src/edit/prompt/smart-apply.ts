...
export const SMART_APPLY_PROMPT = {
    system: psDedent`
        - You are an AI programming assistant who is an expert in determining the best way to apply a suggested code change to a file.
        ...
        - You will be provided with the incoming change to this file, enclosed in <${SMART_APPLY_TOPICS.INCOMING}></${SMART_APPLY_TOPICS.INCOMING}> XML tags. This change has been previously generated by the AI assistant.
