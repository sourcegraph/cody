/**
 * This command structure is copied/adapted from https://github.com/princeton-nlp/SWE-agent/tree/6d8eee91074e56b6b1f134d85bb78ead438aa03b.
 */
...
# docstring: moves the window down ${WINDOW} lines`.trimStart(),
        definition: `
scroll_down() {
    if [ -z "$CURRENT_FILE" ]
    then
...
# @yaml
# signature: submit
# docstring: submits your current code and terminates the session`.trimStart(),
        definition: `
submit() {
    cd $ROOT
