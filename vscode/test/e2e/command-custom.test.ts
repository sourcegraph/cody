...
test.extend<ExpectedV2Events>({
    ...
    .skip('create a new user command via the custom commands menu', async ({ page, sidebar }) => {
...
test.extend<ExpectedV2Events>({
    ...
    .skip('execute custom commands with context defined in cody.json', async ({ page, sidebar }) => {
        await sidebarSignin(page, sidebar)
        ...
        await expect(
            chatPanel.getByText('Add four context files from the current directory.')
        ).toBeVisible()
...
test.extend<ExpectedV2Events>({
    ...
    .skip('open and delete cody.json from the custom command menu', async ({ page, sidebar }) => {
        await sidebarSignin(page, sidebar)
