...
export function AddServerDialog({ onAddServer, className }: AddServerDialogProps) {
    const [open, setOpen] = React.useState(false)
    const [formData, setFormData] = React.useState({ ...DEFAULT_CONFIG })
    ...
    const removeArg = (index: number) => {
        setFormData({
            ...formData,
            args: [...formData.args]?.splice(index, 1),
        })
    }
