...
import { FileMathSearchResult } from './CodeSnippet'

const meta: Meta<typeof FileMathSearchResult> = {
    title: 'cody/FileMathSearchResult',
    component: FileMathSearchResult,
...
type Story = StoryObj<typeof FileMathSearchResult>
