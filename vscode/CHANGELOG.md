...
- Fixed issue where clicking context files wouldn't open them

### Changed

- Chat now prefers sparse vector search context by default and incorporates context from dense vector search as a supplementary context source.
