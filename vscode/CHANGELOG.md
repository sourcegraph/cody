...
- Autocomplete: Remove support for the deprecated `experimental-openaicompatible` provider. Use `openaicompatible` instead. [pull/5987](https://github.com/sourcegraph/cody/pull/5987)
