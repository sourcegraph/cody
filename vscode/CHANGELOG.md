...
- New `Insert to File` button for inserting code from code blocks in sidebar chat into new / exisiting files. [pull/1119](https://github.com/sourcegraph/cody/pull/1119)
