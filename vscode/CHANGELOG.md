...
- Chat: Chat has been added back to the VS Code sidebar (after being removed about 6 months ago). By default, new chats open in the sidebar. New chats can still be opened in an editor panel with the `New Chat in Sidebar` command. Currently open chats can be moved from the sidebar into an editor panel and vice versa. This change applies only to Cody Free and Cody Pro users. Enterprise Cody users will still have the old behavior. [pull/4832](https://github.com/sourcegraph/cody/pull/4832)
