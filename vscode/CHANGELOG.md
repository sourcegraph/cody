...
- Rank autocomplete suggestion with tree-sitter when `cody.autocomplete.experimental.syntacticPostProcessing` is enabled. [pull/000](https://github.com/sourcegraph/cody/pull/000)
