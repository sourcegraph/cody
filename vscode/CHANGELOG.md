...
- Chat: Ability to execute terminal commands generated by Cody directly from the chat interface on button click.
- Internal: "Cody Command Line" an new experimental command that allows users to ask Cody to generate terminal commands using natural language.
