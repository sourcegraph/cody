...
- Debug: Added `Export Logs` functionality to `Settings & Support` sidebar for exporting output logs when `cody.debug.enabled` is enabled. [pull/3256](https://github.com/sourcegraph/cody/pull/3256)
